...
<div class="wrapper">
 ...
 <div class="row box-hd">
      <div class="col-xs-6">
      <strong class="name"><?php echo $pos_name; ?>  </strong>
      <address>
    ...
    <div class="row invoice-info">
      ...
      <div class="col-xs-6  pl-5 ">
        <div class="box-body box-border  box-r">
          <!-- <b>เลขที่ใบกำกับ : </b><?php echo $inv_no; ?><br>
          <b>วันที่ :</b> <?php echo date("d/m/Y H:i:s") ;?><br> -->
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <table class="table t-item">
          ...
          <tr>
            <td  class="center"><?php echo $ic++; ?></td>
            <td><?php echo $item['product_Name']; ?>  </td>
            <td class="center"><?php echo $item['qty']. ' '. $item['unit_name']; ?></td>
            <td class="text-right"><?php echo  $sell_price; ?></td>
    ...
    <div class="row">
      ...
      <div class="col-xs-7">
        ...
        <p class="well well-sm no-shadow center baht-txt"  >
           (<?php echo baht_text($total_amount); ?>)
        </p>
      </div>
      <!-- /.col -->
        ...
        <div class="table-responsive">
          <table class="table table-borderless" style="margin-bottom: 0px;">
            ...
            <tr>
              ...
              <td class="text-right"><?php echo number_format($total_dis, 2);?></td>
            </tr> -->
            <tr>
              <th>มูลค่ารวมก่อนภาษี</th>
              <td class="text-right"><?php echo number_format($total_bf, 2);?></td>
            </tr> 
            <tr>
